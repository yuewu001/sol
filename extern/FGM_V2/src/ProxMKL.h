...
public:
	...
	void ProxMKL::calculate_alpha();
	void ProxMKL::return_model();
	void ProxMKL::mkl_svm_train();
	...
	double ProxMKL::calculate_gradient(double *gw,double *w);
	...
	double ProxMKL::line_search_logistic(double *v, double *gw, double *normsq,	double *normsq_search,
		double tau, double *b0,double *b, double *upd_t, double fv,double lambda,double &f_w_,double o_mega);
