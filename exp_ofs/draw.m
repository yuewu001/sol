...
opt_list = {'AROW-FS.txt';'OFSGD.txt';'SGD-FS.txt';'liblinear.txt';'fgm.txt';'mRMR.txt'};
...
for k = 1:1:opt_num
    ...
    if strcmp(opt_name,'SGD-FS') == 1 || strcmp(opt_name,'OFSGD') == 1 || strcmp(opt_name,'AROW-FS') == 1 || strcmp(opt_name,'mRMR') == 1
    ...
    box on
    hold on    
    plot(sparse_vec, t_err_vec, color_shape,'LineWidth',2,'markersize',15);    
...
set( gca_legend, 'Position', [po(1) + 0.03, po(2)+0.15, po(3), po(4)] );
